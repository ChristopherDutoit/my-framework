<nav class="bg-gray-800">
    <div class="container mx-auto px-6 pv-3 lg:flex lg:justify-between lg:items-center">
        ...
        <div class="hidden lg:flex lg:items-center lg:w-auto w-full" id="mobileMenu">
            <ul class="lg:flex items-center justify-between text-base text-white pt-4 lg:pt-0">
                ...
                <li><a class="lg:p-4 py-3 px-0 block border-b-2 border-transparent lg:border-none hover:border-indigo-400" href="page1">Page1</a></li>
                <li class="relative">
                    ...
                    <ul id="dropdownMenu" class="absolute hidden text-gray-700 pt-1">
                        <li><a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="page2">Page2</a></li>
                        <li><a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="page3">Page3</a></li>
                    </ul>
                </li>
            </ul>
        </div>
